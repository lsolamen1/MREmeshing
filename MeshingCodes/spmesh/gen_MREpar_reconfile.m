function gen_MREpar_reconfile(name,dir,itmax,freq,reg,spfilt,udopt,znopt,diag,ovrlp,sim)
...
if(sim==1)
    ...
    fprintf(fid,['~/meshes/',name,'.mesh/',name,'.bnod\n']);    
else
