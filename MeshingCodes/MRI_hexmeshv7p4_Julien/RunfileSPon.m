function [mvfiles]=RunfileSPon(outstm,default,meshprop,mvfiles,namefile,...
    freqHz,outpath,vox,zoneprop)
    viscoutputfv7p3isoincomp=[outstm  '_G' sprintf('%4.0f',meshprop.muest) '.v7.3.inv.iso.incomp.visc_SPon'];
